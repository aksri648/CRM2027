"""
Telemetry configuration for the channelization microservice.
...
class TelemetryConfig:
    ...
    def __post_init__(self):
        ...
        # Service identification
        self.service_name = self.service_name or os.getenv("OTEL_SERVICE_NAME", "channelization-microservice")
